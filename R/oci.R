                        ...
                        unicode_as_utf8 = TRUE, ora.attributes = FALSE)
{
  .Call("rociDrvInit", drv@handle, interruptible, extproc.ctx, unicode_as_utf8,
        ora.attributes, PACKAGE = "BNT.ROracle")
  drv
}

.oci.UnloadDriver <- function(drv)
{
  .Call("rociDrvTerm", drv@handle, PACKAGE = "BNT.ROracle")
  TRUE
}

.oci.DriverInfo <- function(drv, what)
{
  info <- .Call("rociDrvInfo", drv@handle, PACKAGE = "BNT.ROracle")
                         ...
                         external_credentials = FALSE, sysdba = FALSE)
{
  ...
  timesten <- (.Call("rociConInfo", hdl, 
                      PACKAGE = "BNT.ROracle")$serverType == "TimesTen IMDB")
  new("OraConnection", handle = hdl, timesten = timesten)
}

.oci.Disconnect <- function(con)
{
  .Call("rociConTerm", con@handle, PACKAGE = "BNT.ROracle")
  TRUE
}
                           ...
                           bulk_read = 1000L, bulk_write = 1000L)
{
  ...
  hdl <- .Call("rociResInit", con@handle, stmt, data, prefetch,
               bulk_read, bulk_write, PACKAGE = "BNT.ROracle")
                           ...
                           bulk_read = 1000L, bulk_write = 1000L)
{
  ...
  hdl <- .Call("rociResInit", con@handle, stmt, data,
               prefetch, bulk_read, bulk_write, PACKAGE = "BNT.ROracle")
  res <- try(
  {
    eof_res <- .Call("rociEOFRes", hdl, PACKAGE = "BNT.ROracle")
    if (eof_res)
      TRUE
    else
      .Call("rociResFetch", hdl, -1L, PACKAGE = "BNT.ROracle")
  }, silent = TRUE)

  .Call("rociResTerm", hdl, PACKAGE = "BNT.ROracle")
...
{
  .Call("rociConError", con@handle, PACKAGE = "BNT.ROracle")
}

.oci.ConnectionInfo <- function(con, what)
{
  info <- .Call("rociConInfo", con@handle, PACKAGE = "BNT.ROracle")
...
.oci.Begin   <- function(con)
{
  ...
  if (info$serverType == "Oracle Extproc")
    ...
    .Call("rociConBegin", con@handle, PACKAGE = "BNT.ROracle")
  TRUE
}
...
.oci.Commit   <- function(con)
{
  ...
  if (info$serverType == "Oracle Extproc")
    ...
    .Call("rociConCommit", con@handle, PACKAGE = "BNT.ROracle")
  TRUE
}
...
.oci.Rollback <- function(con)
{
  ...
  if (info$serverType == "Oracle Extproc")
    ...
    .Call("rociConRollback", con@handle, PACKAGE = "BNT.ROracle")  
  TRUE
}
...
{
  eof_res <- .Call("rociEOFRes", res@handle, PACKAGE = "BNT.ROracle")
  if (eof_res)
    stop("no more data to fetch")

  df <- try(
  {
    .Call("rociResFetch", res@handle, n, PACKAGE = "BNT.ROracle")
  }, silent = TRUE)
...
{
  .Call("rociResTerm", res@handle, PACKAGE = "BNT.ROracle")
  TRUE
}

.oci.ResultInfo <- function(res, what)
{
  info <- .Call("rociResInfo", res@handle, PACKAGE = "BNT.ROracle")
  if (!missing(what))
    info <- info[what]
  info
}
...
.oci.execute <- function(res, data = NULL)
{
  ...
  .Call("rociResExec", res@handle, data, PACKAGE = "BNT.ROracle")
}
...
.oci.dbType <- function(obj, ora.number = FALSE, timesten = FALSE, date = FALSE)
{
  ...
  if (timesten)
  {
    ...
    switch(typeof(obj),
           ...
           list      = "varbinary(2000)",
           stop(gettextf("BNT.ROracle internal error [%s, %d, %s]",
